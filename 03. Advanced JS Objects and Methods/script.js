...
a) question itself
b) the answers from which the player can choose to correct one (choose an adequate data structure here,
array, object, etc.)
...
question should have a number) (Hint: write a method for Question objects for this task).
...
user wites 'exit' instead of the answer. In this case, DON'T call the function from task 8.
